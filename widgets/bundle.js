...
var Clock = function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      var time = this.state.time.toTimeString().slice(0, 9) + this.state.time.toTimeString().slice(19).replace(')', '');
...
var Tabs = function (_React$Component) {
  ...
  function Tabs(props) {
    ...
    for (var i = 0; i < _this.props.tabs.length; i++) {
      var object = _this.props.tabs[i];
      _this.titles.push(object['title']);
      _this.contents.push(object['content']);
    }

    _this.state = {
      index: 0
    };
    _this.headerHandler = _this.headerHandler.bind(_this);
    return _this;
  }

  _createClass(Tabs, [{
    key: 'headerHandler',
    value: function headerHandler(index) {
      var _this2 = this;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.titles.map(function (title, index) {
            return _react2.default.createElement(
              'li',
              { onClick: _this3.headerHandler(index), key: index },
